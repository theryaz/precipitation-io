...
class FlaskBackend(Plugin):
    ...
    def __init__(self, config: dict, irrigation_system, logger):
        ...
        self.app.add_url_rule("/turn_pump_on", view_func=self.turn_pump_on, methods=["POST"])
        self.app.add_url_rule("/turn_pump_off", view_func=self.turn_pump_off, methods=["POST"])
    ...
    def get_status(self):
        return {
            ...
            "current_volume_litres": self.irrigation_system.current_volume_litres,
